...
| `-c`  | `--chunksize`         | Genomic position weight budget per processing chunk (applied to standard loci). | `50000` |
| —     | `--chunk-size-max-depth` | Maximum hotspot chunk length when `NEAR_MAX_DEPTH` is `true` in the TSV. | `3`     |
