...
//!
//! This module provides various utility functions used throughout REDICAT,
//! including thread pool management, error handling, and file I/O operations.
//!
//! Key functions include:
//! - Thread pool size determination
//! - Broken pipe error detection
//! - CSV reader/writer creation
